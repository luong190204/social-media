  ...
  return (
    <div className="flex-1 max-w-md mx-4">
      <div className="relative">
        ...
        {/* Popup Results */}
        {isFocused && (
          <div className="absolute top-full left-0 w-full bg-white rounded-2xl shadow-2xl mt-2 z-50 border border-gray-100 overflow-hidden animate-in fade-in slide-in-from-top-2 duration-200">
                    ...
                    {searchResults.map((user) => (
                      ...
                      >
                        <div className="relative">
                          ...
                          />
                          {/* Online indicator - Nếu có trường isOnline */}
                          {user.isOnline && (
